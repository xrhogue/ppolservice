<%@page import="com.ppol.auth.GoogleAuthHelper"%>
	...
	<div class="readme">
		...
		<ul>
			...
			<li>Set up allowed Redirect URIs at Google API &rarr; API
				Access. Input: http://localhost:8080/jsp/auth.jsp</li>
		...
		<ol>
			...
			<li>Browse to: <a href="http://localhost:8080/jsp/auth.jsp">http://localhost:8080/jsp/auth.jsp/</a></li>
